<?php
$app->post('/api/AuthoritasSite/getResellerClients', function ($request, $response, $args) {
    $settings = $this->settings;

    //checking properly formed json
    $checkRequest = $this->validation;
    $validateRes = $checkRequest->validate($request, ['apiKey', 'apiSalt', 'domain', 'apiSecret']);
    ...
    $body = array();
    $body['method'] = 'company.getResellerClients';
