<?php
$app->post('/api/AuthoritasSite/suggestKeywords', function ($request, $response, $args) {
    $settings = $this->settings;

    //checking properly formed json
    $checkRequest = $this->validation;
    $validateRes = $checkRequest->validate($request, ['apiKey', 'apiSalt', 'domain', 'apiSecret', 'url']);
    ...
    $body = array();
    $body['method'] = 'site.suggestKeywords';
